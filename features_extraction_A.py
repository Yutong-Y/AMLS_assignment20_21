...
def extract_features_labels(test):
    ...
    if os.path.isdir(images_dir):
        ...
        for img_path in image_paths:
            ...
            file_name = PurePath(img_path).parts[-1]    # for windows, then the file_name is '100.jpg'
            ...
            if features is not None:
                ...
                all_gender_labels.append(gender_labels[name])
                all_smiling_labels.append(smiling_labels[name])                
